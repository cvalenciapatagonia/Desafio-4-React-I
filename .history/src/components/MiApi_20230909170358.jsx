...
function MiApi({ apiURL, sortOption, searchText }) {
  ...
  // Filtra los días feriados en función del valor de búsqueda
  const filteredHolidays = sortedHolidays.filter((holiday) =>
